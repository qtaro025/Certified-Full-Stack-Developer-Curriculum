...
2. You should create three variables: bot_name, botLocation, and favoriteLanguage, that store the bot's name, where it's
    from, and its favorite coding language, respectively.
3. You should use string concatenation to log "My name is (bot_name) and I live on (botLocation)." to the console.
...
11. You should log "It was fun sharing these facts with you. Goodbye! - (bot_name) from (botLocation)." to the
...
console.log("My name is " + bot_name + " and I live on " + botLocation + ".");
