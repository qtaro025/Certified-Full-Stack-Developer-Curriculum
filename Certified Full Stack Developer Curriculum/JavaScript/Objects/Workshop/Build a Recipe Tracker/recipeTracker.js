...
const recipe2 = {
  name: "Chicken Curry",
  ingredients: ["chicken breasts", "coconut milk", "curry powder", "onion", "garlic"],
  ratings: [4, 5, 5, 5],
  cookingTime: 42,
  totalIngredients: null,
  difficultyLevel: '',
...
console.log(`recipe 1 name: ${recipe1Name}, cooking time: ${recipe1CookingTime}`);
console.log(`recipe 2 name: ${recipe2Name}, cooking time: ${recipe2CookingTime}`);
...
console.log(getAverageRating(recipe2.ingredients));
console.log(getAverageRating(recipe3.ingredients));
